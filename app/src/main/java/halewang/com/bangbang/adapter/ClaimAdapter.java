...
public class ClaimAdapter extends BaseQuickAdapter<Requirement, BaseViewHolder>{
    public ClaimAdapter(List<Requirement> data) {
    ...
    protected void convert(BaseViewHolder helper, Requirement item) {
        ...
        if(item.getStatus().equals("zero")){
             helper.setBackgroundRes(R.id.iv_status, R.drawable.ic_ing);
        }else{
