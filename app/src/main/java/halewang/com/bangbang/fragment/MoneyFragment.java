...
public class MoneyFragment extends BaseFragment<MoneyListView,MoneyListPresenter> implements MoneyListView{
    ...
    @Override
    public MoneyListPresenter initPresenter() {
        return new MoneyListPresenter(getActivity());
    }
